...
const calcBtn = document.querySelector('.calculator-calculate');
const priceText = document.querySelector('.calculated-price');
const inputQuantity = document.getElementById('calculator-quantity');
...
function setPrice() {
    let price = parseInt(+marks.value * +inputQuantity.value);
